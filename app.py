...
if uploaded_file is not None:
    ...
    # --- PERBAIKAN: MENGISI SEL KOSONG / MERGED CELL AGAR TIDAK MUNCUL 'NONE' ---
    # Mengisi otomatis sel kosong ke bawah berdasarkan baris di atasnya
    kolom_target = [col for col in ['NO', 'Part ID', 'Description', 'Qty', 'Unit'] if col in df.columns]
    if kolom_target:
        df[kolom_target] = df[kolom_target].ffill()
    # --------------------------------------------------------------------------
