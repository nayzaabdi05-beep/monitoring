...
# Membuat tampilan upload di tengah agar terasa seperti sistem aplikasi utama
...
if uploaded_file is not None:
    ...
    # Tampilan awal jika belum ada file yang di-upload (bersih ala sistem profesional)
